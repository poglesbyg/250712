...
exports.productivityMonitor = exports.automationRouter = void 0;
...
class ProductivityMonitor extends events_1.EventEmitter {
    ...
    async collectMetrics() {
        try {
            ...
            const git = (0, simple_git_1.default)(this.projectPath);
            // Collect git metrics
    ...
    async collectCodeMetrics() {
        try {
            ...
            for (const file of files.slice(0, 50)) {
                try {
                    const content = (0, fs_1.readFileSync)((0, path_1.join)(this.projectPath, file), 'utf-8');
...
exports.productivityMonitor = monitor;
// Schema definitions
...
const alertConfigSchema = zod_1.z.object({
    ...
    condition: zod_1.z.enum(['above', 'below', 'equals']),
...
router.get('/monitoring/metrics', async (req, res) => {
    try {
        ...
        const filteredMetrics = allMetrics.filter(metric => new Date(metric.timestamp) > cutoff);
        res.json({
...
router.get('/monitoring/events', (req, res) => {
    ...
    const onMetricsCollected = (metrics) => {
